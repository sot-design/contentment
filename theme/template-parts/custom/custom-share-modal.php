...
<div x-data="{ isOpen: false, title: '', url: '', img: '' }" x-on:openmodal.window="isOpen = true, title = $event.detail['title'], url = $event.detail['url'], img = $event.detail['img'], imgfull = $event.detail['imgfull']">
    <!-- Modal -->
    <div x-cloak x-transition x-show="isOpen" transition class="fixed inset-0 overflow-y-auto z-50 ">
        <div class="flex items-center justify-center min-h-screen p-6">
            ...
            <div @click.outside="isOpen = false" class="bg-white border shadow-xl p-8 mx-auto z-50 flex flex-col gap-3">
                ...
                <ul class="text-sm">
                    <li class="mb-2">
                        <button @click="shareTo('facebook', url, title, img)" class="button-outline w-full flex gap-2 items-center justify-center">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('whatsapp', url, title, img)" class="button-outline w-full flex gap-2 items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('pinterest', url, title, img)" class="button-outline w-full flex gap-2 items-center justify-center">
                            <svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('twitter', url, title, img)" class="button-outline w-full flex gap-2 items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
