...
<div x-data="{ isOpen: false, title: '', url: '', img: '', imgfull: ''}" x-on:openmodal.window="isOpen = true, title = $event.detail['title'], url = $event.detail['url'], img = $event.detail['img'], imgfull = $event.detail['imgfull']">
    ...
    <div x-cloak x-transition x-show="isOpen" transition class="fixed inset-0 z-50 overflow-hidden ">
        <div class="flex min-h-lvh items-center justify-center p-6">
            ...
            <div @click.outside="isOpen = false" class="z-50 mx-auto flex flex-col gap-3 border bg-white p-8 shadow-xl">
                <div class="flex items-center justify-between">
                    <p class="font-montserrat uppercase">Share This Post</p>
                    <div @click="isOpen = false" class="button-outline inline-flex cursor-pointer items-center">
                ...
                <div class="w-auto">
                    <div class="aspect-h-4 aspect-w-4">
                        <img class="size-full object-cover object-center" x-bind:src="img" alt="">
                    </div>
                </div>
                <h2 class="max-w-xs text-center text-2xl font-semibold uppercase" x-text="title"></h2>
                <ul class="text-sm">
                    <li class="mb-2">
                        <button @click="shareTo('facebook', url, title, img, imgfull)" class="button-outline flex w-full items-center justify-center gap-2">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('whatsapp', url, title, img, imgfull)" class="button-outline flex w-full items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('pinterest', url, title, img, imgfull)" class="button-outline flex w-full items-center justify-center gap-2">
                            <svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="mb-2">
                        <button @click="shareTo('twitter', url, title, img, imgfull)" class="button-outline flex w-full items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="mb-2 text-center font-montserrat text-sm uppercase">or</p>
                    <button @click="copyLink(url), isOpen = false" class="button-outline flex w-full items-center justify-center gap-2">
