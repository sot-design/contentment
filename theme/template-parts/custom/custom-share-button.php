...
<div x-data @click="$dispatch('openmodal', { title: '<?php echo esc_html(get_the_title()) ?>', url: '<?php echo esc_url(get_permalink()) ?>', img: '<?php echo esc_url($thumbnail_url) ?>', imgfull: '<?php echo esc_url($thumbnail_url_full) ?>'})" class="cursor-pointer border p-2">
