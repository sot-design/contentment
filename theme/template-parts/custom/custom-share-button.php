...
<div x-data @click="$dispatch('openmodal', { title: '<?php echo esc_html(get_the_title()) ?>', url: '<?php echo esc_url(get_permalink()) ?>', img: '<?php echo $thumbnail_url ?>', imgfull: '<?php echo $thumbnail_url_full ?>'})" class="border p-2 cursor-pointer">
